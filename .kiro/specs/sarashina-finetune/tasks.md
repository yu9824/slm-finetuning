...
- [ ] 1.2 設定データクラスと ConfigManager の実装
...
- [ ] 4. 学習コアと train.py の実装
- [ ] 4.1 TrainingCore（学習ループ）の実装
...
- [ ] 4.2 train.py（学習パイプラインのエントリポイント）の実装
...
- [ ] 7. (P) InferenceRunner（推論スクリプト）の実装
...
- [ ] 11. (P) `configs/hpo_config.yaml` の作成
